...
~Library Usage~
Bootstrap libraries were used to ensure mobile friendliness was achieved.
...
Firebase API was used to store data within a database and enable user authentication.
